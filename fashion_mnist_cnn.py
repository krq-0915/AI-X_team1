...
def main():
    ...
    model = Net().to(device)
    optimizer = optimize.SGD(model.parameters(), lr=args.lr, momentum=args.momentum)
    scheduler = optimize.lr_scheduler.MultiStepLR(optimizer, milestones=[12, 24], gamma=0.1)
